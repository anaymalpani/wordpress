...
Contributors: goodyduru
Tags: theme, material, material design, wordpress admin, backend, backend theme, admin theme, custom admin, custom admin theme, login theme, custom login theme
...
A theme that adds the material design look to your WordPress backend.
...
1. Ability to add a background image to both your admin and login pages.
1. Change the font color, link color and interacted link color in your admin and login pages.
1. Change the font style using google fonts in both your admin and login pages.
1. Preview your changes before you make them.
1. Import and Export your settings so that you can use them in another site.
