...
wp.customize( 'gf_stla_form_id_'+urlParams["formid"]+'[field-sub-labels][font-color]', function( value ) {
    value.bind( function( to ) {
                $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .ginput_complex .ginput_full label' ).css( 'color',to );
             $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .ginput_complex .ginput_right label' ).css( 'color',to );
             $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .ginput_complex .ginput_left label' ).css( 'color',to );
             $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .gfield_time_hour label' ).css( 'color',to );
             $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .gfield_time_minute label' ).css( 'color',to );
             $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .gfield_date_month label' ).css( 'color',to );
             $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .gfield_date_day label' ).css( 'color',to );
             $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .gfield_date_year label' ).css( 'color',to );

              $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .name_first label' ).css( 'color',to );
             $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .name_last label' ).css( 'color',to );
             
             $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .address_line_1 label' ).css( 'color',to );
             $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .address_line_2 label' ).css( 'color',to );
             $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .address_city label' ).css( 'color',to );
             $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .address_state label' ).css( 'color',to );
             $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .address_zip label' ).css( 'color',to );
             $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .address_country label' ).css( 'color',to );
         } );
  } );

   wp.customize( 'gf_stla_form_id_'+urlParams["formid"]+'[field-sub-labels][font-size]', function( value ) {
    value.bind( function( to ) {
            $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .ginput_complex .ginput_full label' ).css( 'font-size',to );
             $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .ginput_complex .ginput_right label' ).css( 'font-size',to );
             $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .ginput_complex .ginput_left label' ).css( 'font-size',to );
             $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .gfield_time_hour label' ).css( 'font-size',to );
             $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .gfield_time_minute label' ).css( 'font-size',to );
             $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .gfield_date_month label' ).css( 'font-size',to );
             $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .gfield_date_day label' ).css( 'font-size',to );
             $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .gfield_date_year label' ).css( 'font-size',to );

             $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .name_first label' ).css( 'font-size',to );
             $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .name_last label' ).css( 'font-size',to );
             $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .address_line_1 label' ).css( 'font-size',to );
             $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .address_line_2 label' ).css( 'font-size',to );
             $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .address_city label' ).css( 'font-size',to );
             $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .address_state label' ).css( 'font-size',to );
             $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .address_zip label' ).css( 'font-size',to );
             $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .address_country label' ).css( 'font-size',to );

         } );
  } );


wp.customize( 'gf_stla_form_id_'+urlParams["formid"]+'[field-sub-labels][padding]', function( value ) {
    value.bind( function( to ) {
            $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .ginput_complex .ginput_full label' ).css( 'padding',to);
             $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .ginput_complex .ginput_right label' ).css( 'padding',to );
             $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .ginput_complex .ginput_left label' ).css( 'padding',to );
             $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .gfield_time_hour label' ).css( 'padding',to);
             $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .gfield_time_minute label' ).css( 'padding',to );
             $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .gfield_date_month label' ).css( 'padding',to );
             $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .gfield_date_day label' ).css( 'padding',to );
             $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .gfield_date_year label' ).css( 'padding',to );

             $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .name_first label' ).css( 'padding',to);
             $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .name_last label' ).css( 'padding',to );
             $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .address_line_1 label' ).css( 'padding',to );
             $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .address_line_2 label' ).css( 'padding',to);
             $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .address_city label' ).css( 'padding',to );
             $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .address_state label' ).css( 'padding',to );
             $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .address_zip label' ).css( 'padding',to );
             $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .address_country label' ).css( 'padding',to );
         } );
  } );
//********************************* Field Descriptions *******************************************
...
//********************************* List Field Table*******************************************
  ...
  wp.customize( 'gf_stla_form_id_'+urlParams["formid"]+'[list-field-table][background-color]', function( value ) {
    value.bind( function( to ) {
            $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .ginput_list' ).css( 'background-color',to );
         } );
  } );

  //********************************* List Field Heading*******************************************

   wp.customize( 'gf_stla_form_id_'+urlParams["formid"]+'[list-field-heading][font-size]', function( value ) {
    value.bind( function( to ) {
            $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .ginput_list table.gfield_list thead th' ).css( 'font-size',to );
         } );
  } );

   wp.customize( 'gf_stla_form_id_'+urlParams["formid"]+'[list-field-heading][font-color]', function( value ) {
    value.bind( function( to ) {
            $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .ginput_list table.gfield_list thead th' ).css( 'color',to );
         } );
  } );

   wp.customize( 'gf_stla_form_id_'+urlParams["formid"]+'[list-field-heading][background-color]', function( value ) {
    value.bind( function( to ) {
            $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .ginput_list table.gfield_list thead th' ).css( 'background-color',to );
         } );
  } );

   wp.customize( 'gf_stla_form_id_'+urlParams["formid"]+'[list-field-heading][text-align]', function( value ) {
    value.bind( function( to ) {
            $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .ginput_list table.gfield_list thead th' ).css( 'text-align',to );
         } );
  } );

   wp.customize( 'gf_stla_form_id_'+urlParams["formid"]+'[list-field-heading][padding]', function( value ) {
    value.bind( function( to ) {
            $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .ginput_list table.gfield_list thead th' ).css( 'padding',to );
         } );
  } );

//********************************* List Field Cell*******************************************

   wp.customize( 'gf_stla_form_id_'+urlParams["formid"]+'[list-field-cell][font-size]', function( value ) {
    value.bind( function( to ) {
            $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .ginput_list table.gfield_list tbody tr td.gfield_list_cell input' ).css( 'font-size',to );
         } );
  } );

      wp.customize( 'gf_stla_form_id_'+urlParams["formid"]+'[list-field-cell][font-color]', function( value ) {
    value.bind( function( to ) {
            $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .ginput_list table.gfield_list tbody tr td.gfield_list_cell input' ).css( 'color',to );
         } );
  } );

     wp.customize( 'gf_stla_form_id_'+urlParams["formid"]+'[list-field-cell][background-color]', function( value ) {
    value.bind( function( to ) {
            $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .ginput_list table.gfield_list tbody tr td.gfield_list_cell input' ).css( 'background-color',to );
         } );
  } );

     wp.customize( 'gf_stla_form_id_'+urlParams["formid"]+'[list-field-cell][text-align]', function( value ) {
    value.bind( function( to ) {
            $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .ginput_list table.gfield_list tbody tr td.gfield_list_cell input' ).css( 'text-align',to );
         } );
  } );

  //********************************* List Field Cell Container*******************************************

   wp.customize( 'gf_stla_form_id_'+urlParams["formid"]+'[list-field-cell-container][padding]', function( value ) {
    value.bind( function( to ) {
            $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gfield .ginput_list table.gfield_list tbody tr td.gfield_list_cell' ).css( 'padding',to );
         } );
  } );
...
//********************************* Submit Button *******************************************
  ...
  wp.customize( 'gf_stla_form_id_'+urlParams["formid"]+'[submit-button][button-color]', function( value ) {
    value.bind( function( to ) {
            $( '#gform_wrapper_'+urlParams["formid"]+' .gform_footer input[type=submit]' ).css( 'background',to );
            $( '#gform_wrapper_'+urlParams["formid"]+' .gform_footer button.mdl-button' ).css( 'background',to );
         } );
  } );
...
wp.customize( 'gf_stla_form_id_'+urlParams["formid"]+'[submit-button][width]', function( value ) {
    value.bind( function( to ) {
            ...
            $( '#gform_wrapper_'+urlParams["formid"]+' .gform_footer button.mdl-button' ).css( 'width',to );
         } );
  } );
...
wp.customize( 'gf_stla_form_id_'+urlParams["formid"]+'[submit-button][height]', function( value ) {
    value.bind( function( to ) {
            ...
            $( '#gform_wrapper_'+urlParams["formid"]+' .gform_footer button.mdl-button' ).css( 'height',to );
         } );
  } );
...
wp.customize( 'gf_stla_form_id_'+urlParams["formid"]+'[submit-button][button-align]', function( value ) {
    value.bind( function( to ) {
            ...
            $( '#gform_wrapper_'+urlParams["formid"]+' .gform_footer button.mdl-button' ).css( 'float',to );
         } );
  } );
...
wp.customize( 'gf_stla_form_id_'+urlParams["formid"]+'[submit-button][font-size]', function( value ) {
    value.bind( function( to ) {
            ...
            $( '#gform_wrapper_'+urlParams["formid"]+' .gform_footer button.mdl-button' ).css( 'font-size',to );
         } );
  } );
...
wp.customize( 'gf_stla_form_id_'+urlParams["formid"]+'[submit-button][border-size]', function( value ) {
    value.bind( function( to ) {
            ...
            $( '#gform_wrapper_'+urlParams["formid"]+' .gform_footer button.mdl-button' ).css( 'border-width',to );
         } );
  } );
...
wp.customize( 'gf_stla_form_id_'+urlParams["formid"]+'[submit-button][border-type]', function( value ) {
    value.bind( function( to ) {
            ...
            $( '#gform_wrapper_'+urlParams["formid"]+' .gform_footer button.mdl-button' ).css( 'border-style',to );
         } );
  } );
...
wp.customize( 'gf_stla_form_id_'+urlParams["formid"]+'[submit-button][border-color]', function( value ) {
    value.bind( function( to ) {
            ...
            $( '#gform_wrapper_'+urlParams["formid"]+' .gform_footer button.mdl-button' ).css( 'border-color',to );
         } );
  } );
...
wp.customize( 'gf_stla_form_id_'+urlParams["formid"]+'[submit-button][border-radius]', function( value ) {
    value.bind( function( to ) {
            ...
            $( '#gform_wrapper_'+urlParams["formid"]+' .gform_footer button.mdl-button' ).css( 'border-radius',to );
         } );
  } );
...
wp.customize( 'gf_stla_form_id_'+urlParams["formid"]+'[submit-button][font-color]', function( value ) {
    value.bind( function( to ) {
            ...
            $( '#gform_wrapper_'+urlParams["formid"]+' .gform_footer button.mdl-button' ).css( 'color',to );
         } );
  } );
...
wp.customize( 'gf_stla_form_id_'+urlParams["formid"]+'[submit-button][margin]', function( value ) {
    value.bind( function( to ) {
            ...
            $( '#gform_wrapper_'+urlParams["formid"]+' .gform_footer button.mdl-button' ).css( 'margin',to );
         } );
  } );
...
wp.customize( 'gf_stla_form_id_'+urlParams["formid"]+'[submit-button][padding]', function( value ) {
    value.bind( function( to ) {
            ...
            $( '#gform_wrapper_'+urlParams["formid"]+' .gform_footer button.mdl-button' ).css( 'padding',to);
         } );
  } );
...
wp.customize( 'gf_stla_form_id_'+urlParams["formid"]+'[section-break-title][background-color]', function( value ) {
    value.bind( function( to ) {
            $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gsection .gsection_title' ).css( 'background-color',to );
         } );
  } );
...
//********************************* Section Break Description *******************************************
  ...
  wp.customize( 'gf_stla_form_id_'+urlParams["formid"]+'[section-break-description][background-color]', function( value ) {
    value.bind( function( to ) {
            $( '#gform_wrapper_'+urlParams["formid"]+' .gform_body .gform_fields .gsection .gsection_description' ).css( 'background-color',to );
         } );
 } );
