...
?>
		...
		<div class="stla-extend-buttons">
		<a href="https://wpmonks.com/downloads/widget-sidebar-addon?src=admmenu" target="_blank" class="button-secondary nf-doc-button">Documentation</a>
		<a href="https://wpmonks.com/downloads/widget-sidebar-addon?src=admmenu" target="_blank" title="Conditional Logic" class="button-primary nf-button">Learn More</a>
		</div>
		</div>
		</div> <!-- End Stla Box -->
		...
		<div class="stla-extend stla-box">
		<img src="<?php echo GF_STLA_URL; ?>/css/images/woocommerce-addon.jpg">
		<h2>WooCommerce Addon</h2>
		<div class="stla-extend-content">
		<p>Save styles for forms added using Gravity Forms Product Add-ons WooCommerce plugin</p>
		<div class="stla-extend-buttons">
		<a href="https://wpmonks.com/downloads/woocommerce-addon?src=admmenu" target="_blank" class="button-secondary nf-doc-button">Documentation</a>
		<a href="https://wpmonks.com/downloads/woocommerce-addon?src=admmenu" target="_blank" title="Conditional Logic" class="button-primary nf-button">Learn More</a>
		</div>
		</div>
		</div> <!-- End Stla Box -->
