...
<div id="shortcode-generator">
    ...
    <div class="shortcode-content">     
        ...
        <div class="content"><select id="themeum-shortcodes" data-placeholder="' . __("Choose a shortcode", 'themeum') .'">
        <option value=""> - Select a shortcode - </option>';
        
        foreach( $themeum_shortcodes as $shortcode => $options ){
            ...
            if(strpos($shortcode,'header') !== false) {
                ...
                if( !empty($options['attr']) ){
                     foreach( $options['attr'] as $name => $attr_option ){
                        $html_options .= themeum_option_element( $name, $attr_option, $options['type'], $shortcode );
                     }
                }
...
<!--style-->
<link rel="stylesheet" href="<?php echo plugins_url(); ?>/themeum-enter-shortcodes/css/style.css" />
<!--scripts-->
<script src="<?php echo plugins_url(); ?>/themeum-enter-shortcodes/js/popup.js"></script>
...
<?php echo $shortcode_html . $html_options;  ?>
    ...
    <div id="shortcode-content">
        ...
        <div class="label"><label id="option-label" for="shortcode-content"><strong><?php echo __( 'Content: ', 'themeum' ); ?></strong> </label></div>
    ...
    <a class="btn" id="add-shortcode"><?php echo __( 'Add Shortcode', 'themeum' ); ?></a>
