...
class biznez_lite_breadcrumb_class {

    var $opts;
	
    function biznez_lite_custom_breadcrumb() {
		
		if( get_theme_mod('_breadcrumb_sep', 'on') == 'on' ) {
			$ske_bstype = "<span class='brd_arr'></span>";
		} else {
			$ske_bstype = " ".esc_attr( get_theme_mod('_bdcrumb_stxt', ' / ') );
		}
        ...
        $output = $this->biznez_lite_simple_breadcrumb_case($post);
    ...
    function biznez_lite_simple_breadcrumb_case($der_post) {
        ...
        if (is_page()) {
            ...
            if ($der_post->post_parent) {
                ...
                $this->biznez_lite_simple_breadcrumb_case($my_query);
        ...
        if (is_author()) {
           ...
           global $wp_query;
            ...
            return sprintf( __('Author : %', 'biznez-lite'), $curauth->display_name );
        ...
        if (is_tag()) {
            ...
            return sprintf( __('Tag : %s', 'biznez-lite'), single_tag_title('', false) );
...
$biznez_breadcumb = new biznez_lite_breadcrumb_class();
